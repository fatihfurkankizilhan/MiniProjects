package miniproject02.BiletBus;
...
public class Bilet {
    ...
    public static void main(String[] args) {
        ...
        int  yas = 0;
        int  yolculukTipi = 1;
        String plakaNumarasi = "01 ADA 35";
        ...
        System.out.println("Yolculuk tipiniz sadece gidis ise 1 Gidis Donus ise 2 Giriniz");
    ...
    private static void biletDokum(String plakaNumarasi, int km, int yolculukTipi,double biletUcreti) {
        ...
        slowPrint("KEYIFLI YOLCULUKLAR DILERIZ....",20);
    }
